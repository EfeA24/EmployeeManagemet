...
{
    public class ApprovalDelegationRepository : GenericRepository<ApprovalDelegation>, IApprovalDelegationRepository
    {
        public ApprovalDelegationRepository(AppDbContext context) : base(context)
        {
        }
    }
}
