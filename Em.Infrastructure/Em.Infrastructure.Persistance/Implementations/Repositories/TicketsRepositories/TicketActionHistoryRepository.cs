...
{
    public class TicketActionHistoryRepository : GenericRepository<TicketActionHistory>, ITicketActionHistoryRepository
    {
        public TicketActionHistoryRepository(AppDbContext context) : base(context)
        {
        }
    }
}
