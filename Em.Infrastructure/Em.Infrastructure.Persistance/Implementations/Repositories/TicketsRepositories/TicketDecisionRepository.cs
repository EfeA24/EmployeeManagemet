...
{
    public class TicketDecisionRepository : GenericRepository<TicketDecision>, ITicketDecisionRepository
    {
        public TicketDecisionRepository(AppDbContext context) : base(context)
        {
        }
    }
}
