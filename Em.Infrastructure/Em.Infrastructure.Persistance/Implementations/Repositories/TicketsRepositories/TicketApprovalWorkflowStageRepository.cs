...
{
    public class TicketApprovalWorkflowStageRepository : GenericRepository<TicketApprovalWorkflowStage>, ITicketApprovalWorkflowStageRepository
    {
        public TicketApprovalWorkflowStageRepository(AppDbContext context) : base(context)
        {
        }
    }
}
