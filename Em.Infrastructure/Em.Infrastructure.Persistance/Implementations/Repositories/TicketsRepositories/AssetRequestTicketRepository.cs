...
{
    public class AssetRequestTicketRepository : GenericRepository<AssetRequestTicket>, IAssetRequestTicketRepository
    {
        public AssetRequestTicketRepository(AppDbContext context) : base(context)
        {
        }
    }
}
